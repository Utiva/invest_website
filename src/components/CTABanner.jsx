    ...
    <section className="pb-10" id="invest">
      <div className="max-w-7xl bg-sky-50 rounded-xl py-12 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-8">
          ...
          <button
            onClick={onSubscribe}
            className="bg-primary text-white px-7 py-3.5 rounded-xl font-semibold hover:bg-primary-dark transition-colors text-sm whitespace-nowrap shadow-lg shadow-primary/20 flex-shrink-0"
          >
            Invest With Us
          </button>
        </div>
